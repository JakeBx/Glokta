...
_NO_ROUTER_FILTER = patch("glokta.infrastructure.hf.client._fetch_router_model_ids", return_value=None)
...
class TestFetchTopHfModels:
    def test_returns_list_of_dicts_with_id(self):
        ...
        with patch("glokta.infrastructure.hf.client.HfApi") as MockApi, _NO_ROUTER_FILTER:
...
class TestFetchTopHfModelsRouterFilter:
    ...
    def test_excludes_model_not_in_router(self):
        ...
        with patch("glokta.infrastructure.hf.client.HfApi") as MockApi, \
             patch("glokta.infrastructure.hf.client.requests") as mock_req:
    ...
    def test_router_called_with_bearer_token(self):
        ...
        from glokta.infrastructure.hf.client import fetch_top_hf_models, _HF_ROUTER_MODELS_URL
